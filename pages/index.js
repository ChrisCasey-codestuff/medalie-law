    ...
    <div className="flex flex-col w-full font-baskerville">
      ...
      <div className="sm:w-full">
        <div className="sm:w-full">
          <img
            src="/palm-trees.jpg"
            className="w-full border-b-2 border-blue-900 h-28 sm:w-full"
          ></img>
        </div>
                ...
                <div className="flex flex-col items-center justify-center text-xl">
                  ...
                  <div className="flex lg:flex-row md:flex-row sm:flex-col text-2xl sm:items-center w-full lg:ml-36">
                    ...
                    >
                      ...
                      <p className="lg:w-3/4 sm:w-full text-black mt-12 text-lg text-center lg:mr-60 sm:mb-10">
                        Medalie & Medalie, PA was founded in 1962 by Don
                        Medalie, whose son, Greg, joined the practice in 2006.
                        Don officially retired in July 2022; however, he remains
                        a valuable consultant to the firm. On Don’s retirement,
                        Kathleen Molchan joined the Firm. She and Greg work
                        together to maintain the high quality of legal service
                        and professionalism that is Don’s legacy. The greatest
                        testament to the reputation of Medalie and Medalie is
                        its representation of the children and grandchildren of
                        many of the firm’s early clients! This “legacy”
                        experience sets us apart from many firms by allowing us
                        to help our clients see the big picture when making the
                        important decisions that impact their life and legacy.
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-row justify-center text-center">
                    <div className="flex flex-col items-center justify-center text-md">
                      <p
                        ...
                        data-aos-duration="1000"
                      >
                        “I am grateful to have been referred to Greg Medalie…
                        His knowledge, ease of communication and efficient use
                        of time are impressive...” -Nancy W.
                      </p>
                      <p
